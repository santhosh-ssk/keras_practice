...
if __name__=="__main__":
    ...
    if len(args)==1:
        ...
        event=args[1]
    if event=='prep':
        base_dir='/home/santhosh/resumes_folder/keras/taxonomy_categorization_using_GRU_encoder_decoder/data/tokenized_data/'
        dsc_dir='/home/santhosh/resumes_folder/keras/taxonomy_categorization_using_GRU_encoder_decoder/data/'
        ...
        save_padded_train_ipt_file=dsc_dir+'vectorized_data/padded_train_ipt.csv'
        train_dataset=Text_Vectorize()
        train_dataset.load_dataset(train_dataset_file)
        train_dataset.fit(train_dataset.dataset,None,True)
        train_dataset.save_index_file(dsc_dir)
        ...
        save_padded_train_opt_file=dsc_dir+'vectorized_data/padded_train_opt.csv'
        ...
        train_opt_dataset.save_index_file(dsc_dir,input_flag=False)
        ...
        save_test_ipt_padded_dataset_file=dsc_dir+'vectorized_data/padded_test_ipt.csv'
        load_index_file=dsc_dir+'ipt_index2tag.csv'
        ...
        save_test_ipt_padded_dataset_file=dsc_dir+'vectorized_data/padded_test_opt.csv'
        load_index_file=dsc_dir+'opt_index2tag.csv'
        test_ipt_dataset=Text_Vectorize()
        test_ipt_dataset.load_index_file(load_index_file)
        test_ipt_dataset.load_dataset(test_ipt_dataset_file)
